...
public class Window extends JFrame {
    ...
    public Window() {
        ...
        JButton openButton;
        buttonPanel.add(openButton = new JButton("Відкрити"));
        JButton saveButton;
        buttonPanel.add(saveButton = new JButton("Зберегти"));
        JButton clearButton;
        buttonPanel.add(clearButton = new JButton("Очистити"));
        JButton exitButton;
        buttonPanel.add(exitButton = new JButton("Закрити"));
        ...
        openButton.addActionListener(e -> {
            fileChooser.setDialogTitle("Вибраний файл");
            fileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
            if (fileChooser.showDialog(null, "Вибраний") == JFileChooser.APPROVE_OPTION)
                try {
        ...
        saveButton.addActionListener(e -> {
            ...
            if (fileChooser.showDialog(null, "Зберегти") == JFileChooser.APPROVE_OPTION)
                try {
